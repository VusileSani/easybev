...
function openMerchantSupport(app, merchant) {
  ...
  app.dialog.querySelector("#merchantSupportForm").addEventListener("submit", event => {
    ...
    app.store.addSupportCase({ source: "merchant", merchantId: merchant.id, subject: app.dialog.querySelector("#supportSubject").value, message: app.dialog.querySelector("#supportMessage").value, priority: app.dialog.querySelector("#supportPriority").value });
    app.closeDialog();
